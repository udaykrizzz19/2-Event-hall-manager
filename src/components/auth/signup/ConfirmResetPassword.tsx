...
import { styles } from "./ConfirmResetPassword.styles";

interface ConfirmResetPasswordProps {
  onVerifySuccess: () => void;
}

export const ConfirmResetPassword: React.FC<ConfirmResetPasswordProps> = ({ onVerifySuccess }) => {
  ...
  const handleVerify = () => {
    // If a 5 digit code is entered, proceed
    if (code.length === 5) {
      onVerifySuccess();
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={{ width: "100%", alignItems: "center" }}>
          ...
          <View style={styles.illustrationContainer}>
            {/* When you add confirm_reset_email.svg to assets/images/loginSignup/, swap this with:
                source={require("../../../../assets/images/loginSignup/confirm_reset_email.svg")} */}
            <Image
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={styles.verifyButtonText}>Verify and Set New Password</Text>
            </TouchableOpacity>
          </View>
        </View>
